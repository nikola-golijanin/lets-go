...
// MinChars MinChars() returns true if a value contains n characters or more.
func MinChars(value string, n int) bool {
	return utf8.RuneCountInString(value) >= n
}

// MaxBytes MaxBytes() returns true if a value contains n bytes or less.
...
// AddNonFieldError AddNonFieldError() adds an error message to the NonFieldErrors array
